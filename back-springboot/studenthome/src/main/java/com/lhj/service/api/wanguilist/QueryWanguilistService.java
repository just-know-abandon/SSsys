...
@Controller
@WebServlet(name = "QueryWanguilistService", urlPatterns={"/api/QueryWanguilistService"})
public class QueryWanguilistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                List<Wanguilist> wanguilists=wanguilistService.getWanguilistByExample(new WanguilistExample());
