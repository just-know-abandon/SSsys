...
@Controller
@WebServlet(name = "UpdateShiwulistService", urlPatterns={"/api/UpdateShiwulistService"})
public class UpdateShiwulistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                ...
                shiwulist.setId(Integer.parseInt(shiwulistId));
                shiwulist.setShiwuxinxi(shiwulistxiuxinxi);
                shiwulist.setSushehao(shiwulistSushehao);
                shiwulistService.updateByKey(shiwulist);
                code = 200;
            } else {
                //参数验证失败
                code = 300;
