...
@Controller
@WebServlet(name = "QueryXueshenglistService", urlPatterns={"/api/QueryXueshenglistService"})
public class QueryXueshenglistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                List<Xueshenglist> xueshenglists=xueshenglistService.getXueshenglistByExample(new XueshenglistExample());
