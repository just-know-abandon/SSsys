...
@Controller
@WebServlet(name = "QuerySushelistService", urlPatterns={"/api/QuerySushelistService"})
public class QuerysushelistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                List<Sushelist> sushelists=sushelistService.getSushelistByExample(new SushelistExample());
