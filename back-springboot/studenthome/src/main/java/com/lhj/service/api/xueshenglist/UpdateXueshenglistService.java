...
@Controller
@WebServlet(name = "UpdateXueshenglistService", urlPatterns={"/api/UpdateXueshenglistService"})
public class UpdateXueshenglistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                ...
                xueshenglist.setId(Integer.parseInt(xueshenglistId));
                ...
                xueshenglistService.updateByKey(xueshenglist);
                code = 200;
            } else {
                //参数验证失败
                code = 300;
