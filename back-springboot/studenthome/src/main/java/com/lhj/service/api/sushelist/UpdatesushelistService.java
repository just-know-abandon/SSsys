...
@Controller
@WebServlet(name = "UpdateSushelistService", urlPatterns = {"/api/UpdateSushelistService"})
public class UpdatesushelistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                ...
                sushelist.setId(Integer.parseInt(sushelistId));
                ...
                sushelistService.updateByKey(sushelist);
                code = 200;
            } else {
                //参数验证失败
                code = 300;
