...
@Controller
@WebServlet(name = "QueryLikeShiwulistService", urlPatterns={"/api/QueryLikeShiwulistService"})
public class QueryLikeShiwulistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                ShiwulistExample shiwulistExample=new ShiwulistExample();
                ShiwulistExample.Criteria shiwulistCriteria=shiwulistExample.createCriteria();
                shiwulistCriteria.andSushehaoLike(QueryValue);
                List<Shiwulist> shiwulists=shiwulistService.getShiwulistByExample(shiwulistExample);
