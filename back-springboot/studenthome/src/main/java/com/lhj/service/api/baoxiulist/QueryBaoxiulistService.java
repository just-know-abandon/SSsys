...
@Controller
@WebServlet(name = "QueryBaoxiulistService", urlPatterns={"/api/QueryBaoxiulistService"})
public class QueryBaoxiulistService extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (parameter.equals("1")) {
                List<Baoxiulist> baoxiulists=baoxiulistService.getBaoxiulistByExample(new BaoxiulistExample());
