...
@Controller
@WebServlet(name = "UpdateWanguilistService", urlPatterns={"/api/UpdateWanguilistService"})
public class UpdateWanguilistService extends HttpServlet {
    @Autowired
